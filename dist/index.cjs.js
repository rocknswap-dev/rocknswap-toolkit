...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: '#101010', backgroundDisabled: 'rgba(255, 255, 255, 0.12)', backgroundAlt: '#222222', cardBorder: '#383241', contrast: '#FFFFFF', dropdown: '#1E1D20', dropdownDeep: '#100C18', invertedContrast: '#000', input: '#424242', inputSecondary: 'none', tertiary: '#424242', text: '#fff', textDisabled: 'rgba(255, 255, 255, 0.5)', textSubtle: '#f7c668', disabled: 'rgba(255, 255, 255, 0.3)', gradients: {
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#9A6AFF", background: "#130906", backgroundDisabled: "rgba(255, 255, 255, 0.12)", backgroundAlt: "#26130d", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#000", input: "#633f36", inputSecondary: "#422a24", tertiary: "#633f36", text: "#fff", textDisabled: "rgba(255, 255, 255, 0.5)", textSubtle: "#d2b4ac", disabled: "rgba(255, 255, 255, 0.3)", gradients: {
        bubblegum: "linear-gradient(139.73deg, #313D5C 0%, #3D2A54 100%)",
        inverseBubblegum: "linear-gradient(139.73deg, #3D2A54 0%, #313D5C 100%)",
        cardHeader: "linear-gradient(111.68deg, #f7c668 0%, #ab802e 100%)",
        blue: "linear-gradient(180deg, #00707F 0%, #19778C 100%)",
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        ...
        React__default['default'].createElement(Text, { fontSize: "24px", bold: true, color: "primary" }, "Rock 'N' Swap")));
    return (React__default['default'].createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", href: href, "aria-label": "Rock 'N' Swap home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink, { to: href, "aria-label": "Rock 'N' Swap home page" }, innerLogo))));
};
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, cakePriceUsd = _a.cakePriceUsd, currentLang = _a.currentLang, langs = _a.langs, setLang = _a.setLang;
    if (!isPushed) {
...
var Avatar = function (_a) {
    ...
    var icon = image ? React__default['default'].createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" }) : React__default['default'].createElement(React__default['default'].Fragment, null);
    if (isExternal) {
